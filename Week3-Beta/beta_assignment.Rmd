...
# Calculate the variation explained by the first three axes in your ordination
explainvar1 = round(plant_06.pcoa$eig[1] / sum(plant_06.pcoa$eig), 3) * 100
explainvar2 = round(plant_06.pcoa$eig[2] / sum(plant_06.pcoa$eig), 3) * 100
explainvar3 = round(plant_06.pcoa$eig[3] / sum(plant_06.pcoa$eig), 3) * 100
sum.eig = sum(explainvar1, explainvar2, explainvar3)
...
# Hypothesis Testing
# H1: Soil treatment (either warming or N fertilization) influenced beta diversity during 2006. 
...
# Run PERMANOVA with adonis function
PERMA.06 = adonis(plant_06_sbys ~ soil_treat, method = "bray", permutations = 999)
PERMA.07 = adonis(plant_07_sbys ~ soil_treat, method = "bray", permutations = 999)
PERMA.08 = adonis(plant_08_sbys ~ soil_treat, method = "bray", permutations = 999)
PERMA.09 = adonis(plant_09_sbys ~ soil_treat, method = "bray", permutations = 999)
