...
> Answer 1:
rnorm generates a string of random numbers from a normal distribution- the output is a vector- for which you can specfy the length, mean and standard deviation
